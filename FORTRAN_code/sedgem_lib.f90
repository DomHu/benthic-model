...
CONTAINS
    ...
    ! ****************************************************************************************************************************** !
    ! CALCULATE SEDIMENT WT% of mol - FROM POC FLUX (FOR BOTH FRACTIONS) - NEEDED FOR HUELSEETAL2016
    function fun_sed_calcCorgwt(dum_FPOC, loc_sed_v_burial, dum_por,dum_den)
        ! -------------------------------------------------------- !
        ! RESULT VARIABLE
        ! -------------------------------------------------------- !
        ...
        real,INTENT(in)::loc_sed_v_burial                          ! burial velocity [cm yr^-1] (Middelburg et al., Deep Sea Res. 1, 1997)
        ...
        ! NOTE: units of (g cm-2 yr-1) -> *1/12 -> (mol cm-2 yr-1)
        loc_sed_Fdet = loc_sed_v_burial*(1.0 - dum_por)*dum_den/12.0
        ! calculate Corg wt%
        ! NOTE: 100% scale
