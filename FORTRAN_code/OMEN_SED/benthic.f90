...
!    print*, '---------------------- START zNH4 ------------------------------- '
    ...
    ! Solution at swi, top of layer 1
    call calcfg_l12(0.0D00, (1-gamma)*NC1/(1.0+KNH4), (1-gamma)*NC2/(1.0+KNH4), 0.0D00, ls_a1, ls_b1, ls_c1, ls_d1, ls_e1, ls_f1, &
                    & DNH41, DNH42, ltype1, e1_00, dedz1_00, f1_00, dfdz1_00, g1_00, dgdz1_00)
