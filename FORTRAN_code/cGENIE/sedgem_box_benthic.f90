...
MODULE sedgem_box_benthic
    ...
    real dum_POC1_conc_swi                !TOC concentration at SWI (wt!) -> (mol/cm3 bulk phase)
    real dum_POC2_conc_swi                !TOC concentration at SWI (wt!) -> (mol/cm3 bulk phase)
    ...
    real dum_swiflux_M                      ! flux of M to the sediment (mol/(cm2*yr))
...
!                        print*,' '
!                        print*,' '
!                        print*,'!!!!!!!!!!!!!!!!!! loc_new_sed_vol <  4.0e-4 !!!!!!!!!!!'
!                        print*,'dum_D = ', dum_D
!                        print*,' grid point (i,j)', dum_i, dum_j
!                        print*,'GENIE loc_new_sed_vol (or deposition rate) = ', loc_new_sed(is_POC)
!                        print*,' '
!                        loc_new_sed_vol =  4.0e-4
!            end if
!        end if
...
!            print*,' grid point (i,j) = ', dum_i, dum_j
            ...
            call sub_huelseetal2016_zTOC(dum_D, loc_POC1_flux_swi, loc_POC2_flux_swi, dum_sed_pres_fracC)
...
!        w = 10.0**(-0.87478367-0.00043512*dum_D)*3.3              ! sedimentation rate, cm/yr / burial velocity / advection (Middelburg et al., Deep Sea Res. 1, 1997)
    ...
    SUBROUTINE sub_huelseetal2016_zTOC(dum_D, dum_POC1_flux_swi, dum_POC2_flux_swi, dum_sed_pres_fracC)
        !   __________________________________________________________
        !
...
!        if(A21 .LE. 10e+5 .OR. A22 .LE. 10e+5)then
!            print*, 'dum_D ', dum_D
!            print*, 'A2i .LE. 10e+5 !'
...
!        end if
    ...
    SUBROUTINE sub_huelseetal2016_zO2(dum_i, dum_j, dum_D, dum_swiconc_O2, loc_new_swiflux_O2)
...
!
!        ! local variables
!        real wdepth, oc1_0, oc2_0
!        real w, dbio, zbio, zbur
!        real doc1_1, doc2_1, doc1_2, doc2_2
!        real koc1, koc2
!        real a_oc1_1, a_oc2_1, a_oc1_2, a_oc2_2
!        real aa_oc1_1, aa_oc2_1, aa_oc1_2, aa_oc2_2
!        real bb_oc1_1, bb_oc2_1 
!        real oc1_zbur, oc2_zbur
!        real f_oc1, f_oc2
