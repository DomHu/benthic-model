...
The model presented here, even more complete than previous analytical models is still an idealised one. In order to solve the model analytically important simplifying assumptions have been made, which limit 
...
If that's the case the sediment column can be described by a series of pseudo steady-states. 
For instance the model cannot be used to predict the response to short-term or seasonal variations of boundary conditions. But it can be useful for investigating the long term effects 
of changes in boundary conditions such as the the input of OM or bottom water oxidation state on OM degradation and burial dynamics, as occurs for instance during OAEs. 

\textbf{Applicability to which environments:}\\
Global scale models, but also regional studies  and in a limited fashion for high productivity areas as strong assumption about steady-state. check e.g. Gypens, Volta and other model development papers...

Soetaert 2000: ``Generalisation of
our evaluation to deep-sea environments and to con-
tinental shelf and estuarine areas should be done
with care. While the seasonal dynamics of nutrient
regeneration in deep-sea sediments can likely be
neglected Ž hence, levels 2, 3 and 4 may converge . ,
higher levels of coupling Ž 3–4 . are necessary to
accurately reproduce carbonate and silica cycling at
a time scale of about 5 kyear Ž Archer and Meier-Re-
imer, 1994; Archer et al., 1998; Sigman et al., 1998;
Heinze et al., 1999 . . In coastal environments, benthic
primary production, groundwater input, extensive re-
suspension–deposition cycles and advective flows
may strongly affect sediment–water exchange and
should therefore be included in coupled benthic–
pelagic models.'' 

\textbf{reoxidation of a fixed fraction of NH4 and H2S:}\\
instead of using a kinetic approach 

\textbf{no overlap in respirations processes:}\\
The lack of overlap in respiration pathways may cause distorted organic matter respiration rates for the different TEAs. For instance, in OMEN-SED denitrification does not occur in the oxic layer, while in reality, 
although inhibited by the presence of oxygen, denitrification can still occur in the oxic zone, even at shallow sediments depths with high OM contents. 
...
Schulz and Zabel:
also applicable for continantal margins or estuaries:
Such complex interactions between different pathways
of organic matter decomposition and redox reac-
tions are restricted to coastal marine environments
and highly accumulating upwelling regions. In
oligotrophic regions of the deep sea, 100 to 1,000-
times more organic carbon is oxidized by oxygen
than by sulfate reduction and other pathways
(Canfield 1989).

\textbf{steady-state assumption:}\\
This assumption is only valid if the Earth system model relevant variability in boundary conditions and fluxes is generally longer than the characteristic timescales of the reaction-transport processes. 
If that's the case the sediment column can be described by a series of pseudo steady-states. 
For instance the model cannot be used to predict the response to short-term or seasonal variations of boundary conditions. But it can be useful for investigating the long term effects 
of changes in boundary conditions such as the the input of OM or bottom water oxidation state on OM degradation and burial dynamics, as occurs for instance during OAEs. 
