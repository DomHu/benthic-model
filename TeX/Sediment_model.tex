...
of OM (i.e. \chem{NH_4}, \chem{Mn^{2+}}, \chem{Fe^{2+}}, \chem{H_2S}, \chem{CH_4}). 
...
Newer versions of the HAMOCC model, being notable exceptions, as \citet{ilyina_global_2013} include \chem{NO_3} and denitrification explicitly and the version of 
...
\citep[with contributions of 55-76\%][]{canfield_aquatic_2005, jorgensen_sulfur_2006, thullner_global_scale_2009}. \citet{thullner_global_scale_2009} found that \chem{O_2} becomes 
...
Thus, the in situ production of \chem{NO_3} and \chem{SO_4} through oxidation of \chem{NH_4} and \chem{H_2S} is an important sink for \chem{O_2} 
...
Schulz and Zabel:
denitrification and nitrification... are of key importance for the distri-
bution of oxygen and nitrate in the sediment
column and can directly be related to the degra-
dation of organic matter.
... The shape of a nitrate profile depends
on the total rate of nitrification and the denitri-
fication rate...
...
and highly accumulating upwelling regions (BUT ARE ALSO IMPORTANT FOR OTHER TIMEPERIODS WITH MORE OM BURIAL!!!). 
In oligotrophic regions of the deep sea, 100 to 1,000-
times more organic carbon is oxidized by oxygen
than by sulfate reduction and other pathways
(Canfield 1989).

P-cycle (more infor on it in Schulz and Zabel): 
After [organic bound P] accumulation on
...
of redox-sensitive iron phases
A simplified illustration of
most relevant processes in the generalised ben-
thic P cycle is given in Figure ...
The major species of dissolved phosphorus in
the marine environment is HPO42-
... the following solid phases could be identified as the
...
oxyhydroxides, 3) fish debris, 4) CFA

% \textbf{problem when O2 only TEA for global studies:} \\
% Thullner: SO4 most important TEA ``suggest that sulfate-based carbon mineralization plays a more important role in global benthic carbon oxidation than previously
% reported.''; O2 becomes progessively less important with decreasing SFD: Sulfate reduction accounts for 76\% of the global
% carbon mineralization rate (16 Tmol yr À1 ) and aerobic respiration only for 15\% (3.1 Tmol yr ... ). 
% Maybe give other data on SO4 importance: data compiled by Canfield [1993] and Canfield et al. [2005] gives a sulfate-based contribution of 55–65\%
% Archer et al. [2002] suggested that aerobic respiration is the dominant respiration pathway at all SFDs, accounting for 66\% of total carbon mineralization.
% It is important to resolve these discrepancies because they imply a major revision of the role of O2 versus SO4 in global carbon cycling in the seafloor. 
% OMENSED could help to resolve these discrepancies!!!
...
that we can expect a decrease of respiration inten-
