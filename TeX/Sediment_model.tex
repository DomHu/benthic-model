...
%>>>
\marginnote{\textbf{DH}: Shall I include the actual table with the parameters for diff. SFD here?}[-1cm]%<<<
%>>>
...
Therefore, the rate of organic matter degradation is about 50 times greater at 100 m \textcolor{red}{(value $\mu$mol cm$^{-3}$ yr$^{-1}$ ???)} than at 5000 m \textcolor{red}{(value ???)}, thus resulting in a decrease of TEA-fluxes along the 
