...
with our model results (not shown). \textcolor{red}{TODO: write one more sentence here}

Comparing with observations compiled by \citet{meile_global_2003} in Fig. \ref{fig:OMEN_GENIE_Boudreau_depthdep_zox_vs_SFD}
...
\begin{center}
	...
	Grid-cells where the entire sediment column is oxic (i.e. $z_{\mathrm{ox}} = 100$) are not considered to calculate the statistics. 
