...
Physical and chemical processes in sediments (diagenesis) depend on the water column and vice versa: Diagenesis is mainly donor controlled, as it is fuelled by the external supply of solid material 
...
At the same time, diagenesis in the sediments transforms the deposited material and returns the resulting products (e.g. nutrients, DIC) to the water column. 
This so-called benthic-pelagic coupling is essential for understanding global biogeochemical cycles and climate \citep[e.g.][]{archer_effect_1994, archer_what_2000, mackenzie_sediments_2005, ridgwell_role_2005}. 

In the marine sediments, most biogeochemical reactions can be related either directly or indirectly to the degradation of organic matter (OM) \citep[e.g][]{boudreau_reactive_1991, arndt_quantifying_2013}. 
Organic matter degradation, for instance, releases metabolic \chem{CO_2} to the pore water, causing it to have a lower pH and provoking the dissolution of \chem{CaCO_3} \citep{emerson_carbon_1981}.
\textcolor{red}{TODO: which cycles are affected!?}\\
%However, the interrelation of these processes is rather complicated and furthermore depends on the prevailing sediment redox chemistry \citep{canfield_sulfate_1989}. 

\textcolor{red}{TODO: next paragr. think about better logical structure!}\\
On the other hand, over long timescales production of OM is generally greater than degradation which results in some organic matter being buried in marine sediments and oxygen accumulating in the atmosphere. 
Thus burial of OM leads to net oxygen input to, and \chem{CO_2} removal from, the atmosphere \citep{berner_phanerozoic_2004}. Furthermore, the sedimenst form an important sink for organic phosphorus and nitrogen. 
Therefore, changes in the burial rate of OM can profoundly affect the oxygen and nutrient inventory of the ocean and thus marine biogeochemical cycling and primary productivity \citep[e.g.][]{lenton_redfield_2000, ???}. 
...
Furthermore, nutrient recycling from the sediments has been used by modelling and data studies to explain the occurance of extreme events in Earth history, for instance Oceanic Anoxic Events (OAEs) 
\citep{bjerrum_modeling_2006, mort_phosphorus_2007, tsandev_modeling_2009}. OAEs represent severe disturbances of the global carbon, oxygen and nutrient cycles of the ocean and are usually characterized 
by widespread bottom water anoxia and photic zone euxinia (occurance of free hydrogen sulfide) \citep{?}. 
One possible mechanism to explain the genesis and persistence of OAEs is increased oxygen demand due to enhanced primary productivity (PP). Increased nutrient inputs to fuel PP may have come from marine sediments as the 
burial efficiency of phosphorus declines when bottom waters become anoxic \citep[e.g.][]{ingall_evidence_1994, van_cappellen_benthic_1994}. 
...
\hline
108 & 12.5 & 1.0 & 0.02 & 2.66 & 1.8 & 0.5 & $1.0e^{-5}$ \\
585 & 5.85 & 0.01 & 0.02 & 2.0 & 3.5 & 0.035 & $5.0e^{-5}$\\
...
Depth & \chem{O_2} & \chem{NO_3} & \chem{SO_4} & \chem{NH_4} & \chem{H_2O} & \chem{PO_4} & \chem{PO_4^a}\\
...
2213 & 250 & 25 & 28,000 & 0.6 & 0.0 & 0.0 & 5.0 \\
4298 & 243 & 30.1 & 28,000 & 0.22 & 0.0 0.0 & 5.0 \\
% inserts double horizontal lines
\end{tabular}
...
\begin{center}
	...
	on the vertical axis) for two hypothetical sediment cores. }
...
\begin{figure}[htbp]
\begin{center}
	\includegraphics[width=1.0\textwidth]{figures/SA/400m_k1_vs_f1_SWIflux_COMBINED.pdf}
	\caption{}
