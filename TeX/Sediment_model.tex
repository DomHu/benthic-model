...
or bottom water oxidation state on degradation and burial dynamics, for instance during OAEs. 
\textcolor{red}{Also mention the secondary redox parameters $\gamma$ here. They are influential for the model output and hence should be formally tuned to a database of SWI-fluxes and/or be parameterised depending on a master variable like seafloor depth or 
oxygenation state.}

Yet, OMEN-SED is not able to predict the system response to short-term or seasonal variations of boundary conditions. 
