...
Dissolved inorganic carbon (DIC) is produced when organic matter is degraded. DIC dynamics are described by: 
\begin{align}
...
Alkalinity is produced and consumed when organic matter is degraded. 
\textcolor{red}{TODO: Explain why it is produced/consumed, where and how in the different layers} $j \in \{I,\ II,\ III,\ IV\}$ and talk earlier on in the model description why it matters.
% \begin{equation}
