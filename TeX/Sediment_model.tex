...
\frac{\partial \chem{ALK}^{I}}{\partial t} &= 0 = D_{\chem{ALK}} \frac{\partial^2\chem{ALK}^{I} }{\partial z^2} - w\frac{\partial \chem{ALK}^{I} }{\partial z} \notag\\
					  & + \frac{1-\phi}{\phi} \cdot \sum_i \left( \chem{ALK}^\mathrm{NIT} \cdot \frac{\gamma_{\chem{NH_4}}}{1+K_\chem{NH_4}} \chem{NC_i} + \chem{ALK}^\mathrm{OX}\cdot \chem{O_2C}\right)\cdot k_i \cdot C_{i}(z) \label{eq:ALK_ODE1_L1}\\
...
&&&\citet{caroline_p_slomp_key_1996}\\
\multicolumn{4}{l}{\textcolor{red}{TODO: Add adsorption coefficients!}}\\
