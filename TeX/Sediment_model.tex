...
degraded \citep[e.g.][]{soetaert_model_1996}. \textcolor{red}{TODO: Go on from here!}
...
Also mention here presented as a 3G-Model (including one ``refractory'' OM pool, whose degradability is not relevant for the timescales considered), however OMEN-SED can easily be extended to a Multi-G approach. \\ [2ex]
