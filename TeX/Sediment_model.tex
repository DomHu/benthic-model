...
$z=z_{\infty}$& \chem{CH_4} flux & 10)& $\frac{\partial \chem{H_2S}}{\partial z}|_{z_\infty}=0$\\
\hline    
\end{tabular}
...
%>>>
\marginnote{\textcolor{red}{\textbf{DH}: BC 5) for \chem{H_2S} should this not be $+(1-\gamma_{\chem{H_2S}})\cdot F_{\chem{H_2S}}$??}}[-3cm]%<<<
\end{table}
Sulfate:\\
