...
\begin{figure}[htbp]
\begin{center}
	\includegraphics[width=0.9\textwidth]{figures/OM_reactivity/OM_degradation_0808.pdf}
	\caption{Idealised organic matter decomposition relationship during remineralisation in the water column and the sediments. A+B: Upper panels show the development 
	of the two organic matter fractions represented in cGENIE in the water column (labile: red, refractory: green, values are normalised OM export at 100m). 
