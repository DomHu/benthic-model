...
$D_{\chem{NH_4}}^0$ & cm$^2$\,yr$^{-1}$ & 309.0528 &Molecular diffusion coefficient of ammonium at 0$^\circ$C\\
...
\end{equation}
where $F_y(y)$ is the unconditional CDF of the output $y$ and $F_{y|x_i}(y)$ represents the conditional CDF when the $i$-th parameter is fixed to $x_i$. For a more detailed description of the method we refer the interested reader to \citet{pianosi_simple_2015}. 

\textcolor{red}{TODO: from here!}
...
Sensitivity indices for all resulting SWI-fluxes for two idealised sediment conditions (i.e. 1) anoxic at 400\,m and 2) oxic at 4000\,m, see Table \ref{table:SA_2Cases}) are calculated. 
