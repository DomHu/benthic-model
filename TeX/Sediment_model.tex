...
Sensitivity studies are carried out using this coupled model and modelled organic matter concentrations in the surface sediments are compared to a global database \citep[][Section \ref{subsubsec:Methods_pre-ind_ESM_simul}]{seiter_organic_2004}. 
...
\begin{empheq}[box={\mybluebox[5pt]}]{equation}
  \frac{\partial C_i}{\partial t} = 0 = \frac{D_i}{1+K_i}\frac{\partial^2C_i }{\partial z^2} - w\frac{\partial C_i }{\partial z} - \frac{1}{1+K_i} \left( k\cdot (C_i - \tilde{C}) + \sum_j \alpha_j \exp(-\beta_j z) - Q \right) \label{eq:generalODE}
\end{empheq}
% \begin{equation} 
...
$k$ is a generic first order reaction rate constant, $\tilde{C}$ is an equilibrium or asymptotic concentration of $C$ and $Q$ is a zeroth-order (or constant) reaction rate.
...
The model assumes known bottom water concentrations for both \chem{NO_3} and \chem{NH_4}, the complete consumption of nitrate at the nitrate penetration depth (in case  $z_{\chem{NO_3}} < z_\infty$) and no change in nitrate and ammonium 
...
methane produced below (with a methane to carbon ratio of \chem{MC}); or, in case $z_{\chem{SO_4}}=z_\infty$, a zero flux condition for sulfate is considered. 
...
The rate constants sorption of \chem{PO_4} to Fe oxides, $k_s$, release of \chem{PO_4} from Fe-bound P due to Fe-oxide reduction $k_m$  and 
