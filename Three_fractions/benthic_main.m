...
classdef benthic_main < handle
    ...
    properties
        ...
        NC3;                                    %N/C second TOC fraction (mol/mol)
        PC1;                                    %P/C third TOC fraction (mol/mol)
        PC2;                                    %P/C second TOC fraction (mol/mol)
        PC3;                                    %P/C third TOC fraction (mol/mol)
        SO4C;                                   %SO4/C (mol/mol)
