...
classdef benthic_zO2
    ...
    methods
        function obj = benthic_zO2(bsd, swi)
            ...
            obj.reac3=-bsd.OC-2*bsd.gamma*bsd.NC3;
        end
        ...
        function [flxzox, conczox, flxswi,r] = calcbc(obj, zox, bsd, swi, r, bctype)
            ...
            rO2.ls = r.zTOC.prepfg_l12(bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, bsd.z0, zox, obj.DO21, obj.DO22);
            
            % basis functions at upper boundary
            [ e_0, dedz_0, f_0, dfdz_0, g_0, dgdz_0] ...
                = r.zTOC.calcfg_l12(bsd.z0, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, rO2.ls);
            % ... and lower boundary
            [ e_zox, dedz_zox, f_zox, dfdz_zox, g_zox, dgdz_zox] ...
                = r.zTOC.calcfg_l12(zox, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, rO2.ls);
        ...
        function FO2 = calcFO2(obj, zox, bsd, swi, r)            
           ...
           %tmpreac3=1*bsd.SO4C+2*bsd.gamma*bsd.NC3;
            tmpreac1=0.2;
            tmpreac2=0.2;
            tmpreac3=0.2;
           %tmpreac1=bsd.OC+2*bsd.gamma*bsd.NC1;
           %tmpreac2=bsd.OC+2*bsd.gamma*bsd.NC2;
           %tmpreac2=bsd.OC+2*bsd.gamma*bsd.NC3;
            %FLUX of NH4 and Reduced species from ZOX to ZINF
            
            
            FO2 = zox./(bsd.zoxgf + zox).*r.zTOC.calcReac(zox, bsd.zinf, tmpreac1, tmpreac2, tmpreac3, bsd, swi, r);
        ...
        function FO2 = calcFO2_exact(obj, zox, bsd, swi, r)            
            % Oxydation of reduced species at zox (CALCULATED WITH PENETRATION DEPTHS)
            
            tmpreac1_N=2*bsd.gamma*bsd.NC1;
            tmpreac2_N=2*bsd.gamma*bsd.NC2;
            tmpreac3_N=2*bsd.gamma*bsd.NC3;
            tmpreac1_S=1*bsd.SO4C;
            tmpreac2_S=1*bsd.SO4C;
            tmpreac3_S=1*bsd.SO4C;
           ...
           %tmpreac2=bsd.OC+2*bsd.gamma*bsd.NC2;
            ...
            FO2 = zox./(bsd.zoxgf + zox).*(r.zTOC.calcReac(r.zno3, bsd.zinf, tmpreac1_N, tmpreac2_N, tmpreac3_N, bsd, swi, r) ...
                + r.zTOC.calcReac(r.zno3, r.zso4, tmpreac1_S, tmpreac2_S, tmpreac3_S, bsd, swi, r));
            % NB (1-bsd.por)/bsd.por  has been included in OC etc stoich factors, so this is flux / cm^2 pore area
        ...
        function [O2, flxO2, flxO2D, flxO2adv] = calcO2(obj, z, bsd, swi, r)
            ...
            if z <= r.zox    % <= so handle case of fully oxic with zox = zinf
                ...
                [ e, dedz, f, dfdz, g, dgdz] ...
                    = r.zTOC.calcfg_l12(z, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, r.rO2.ls);
