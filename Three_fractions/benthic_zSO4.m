...
classdef benthic_zSO4
    ...
    methods
        ...
        function [flxzso4, conczso4, flxswi,r] = calcbc(obj, zso4, bsd, swi, r, bctype)
            ...
            rSO4.ls1 = r.zTOC.prepfg_l12(bsd, swi, r, 0,         0,         0,         0,     0, r.zox, obj.DSO41, obj.DSO42);
            % layer 2: zox < z < zno3, passive diffn
            rSO4.ls2 = r.zTOC.prepfg_l12(bsd, swi, r, 0,         0,         0,         0,  r.zox, r.zno3, obj.DSO41, obj.DSO42);            
            % layer 3: zno3 < z < zso4, SO4 consumption by OM oxidation
            rSO4.ls3 = r.zTOC.prepfg_l12(bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, r.zno3, zso4, obj.DSO41, obj.DSO42);
            ...
            [ e3_zso4, dedz3_zso4, f3_zso4, dfdz3_zso4, g3_zso4, dgdz3_zso4] ...
                = r.zTOC.calcfg_l12(zso4, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, rSO4.ls3);
            ...
            [ e2_zno3, dedz2_zno3, f2_zno3, dfdz2_zno3, g2_zno3, dgdz2_zno3] ...
                = r.zTOC.calcfg_l12(r.zno3, bsd, swi, r,     0,            0, 0, 0, rSO4.ls2);
            % ... and top of layer 3
            [ e3_zno3, dedz3_zno3, f3_zno3, dfdz3_zno3, g3_zno3, dgdz3_zno3] ...1
                = r.zTOC.calcfg_l12(r.zno3, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, rSO4.ls3);
            ...
            FH2S = r.zTOC.calcReac(r.zno3, zso4, bsd.SO4C, bsd.SO4C, bsd.SO4C, bsd, swi, r) ... % MULTIPLY BY 1/POR ????
               + bsd.gammaCH4.*r.zTOC.calcReac(zso4, bsd.zinf, bsd.SO4C, bsd.SO4C, bsd.SO4C, bsd, swi, r);
            % basis functions at bottom of layer 1
            [ e1_zox, dedz1_zox, f1_zox, dfdz1_zox, g1_zox, dgdz1_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, 0 , 0 , 0, 0, rSO4.ls1);
            % basis functions at top of layer 2
            [ e2_zox, dedz2_zox, f2_zox, dfdz2_zox, g2_zox, dgdz2_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, 0, 0, 0, 0, rSO4.ls2);
            ...
            [ e1_0, dedz1_0, f1_0, dfdz1_0, g1_0, dgdz1_0] ...
                = r.zTOC.calcfg_l12(0, bsd, swi, r, 0, 0, 0, 0, rSO4.ls1);
            % transform to use coeffs from l3
        ...
        function FSO4 = calcFSO4(obj, zso4, bsd, swi, r)
           % Calculate SO4 consumption below zso4, by organic matter and indirectly via methane oxidation 
            ...
            tmpreac3    = bsd.SO4C.*bsd.gammaCH4;
     
            FSO4 = r.zTOC.calcReac(zso4, bsd.zinf, tmpreac1, tmpreac2, tmpreac3, bsd, swi, r);
        ...
        function [SO4, flxSO4] = calcSO4(obj, z, bsd, swi, r)
            ...
            if z <= r.zso4
                ...
                if z <= r.zox   % layer 1
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0 , 0, 0, 0, rSO4.ls1);
                    SO4     = r.rSO4.A1.*e + r.rSO4.B1.*f + g;
                    flxSO4  = D.*(r.rSO4.A1.*dedz+r.rSO4.B1.*dfdz + dgdz);
                elseif z <= r.zno3 % layer 2
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0 , 0, 0, 0, rSO4.ls2);
                    SO4     = r.rSO4.A2.*e + r.rSO4.B2.*f + g;
                    flxSO4  = D.*(r.rSO4.A2.*dedz+r.rSO4.B2.*dfdz + dgdz);
                else
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, rSO4.ls3);
