...
classdef benthic_zNH4
    ...
    methods
        function obj = benthic_zNH4(bsd, swi)
            obj.DNH41=(obj.qdispNH4+obj.adispNH4*swi.T).*bsd.dispFactor+bsd.Dbio;                %NH4 diffusion coefficient in bioturbated layer (cm2/yr)
            obj.DNH42=(obj.qdispNH4+obj.adispNH4*swi.T).*bsd.dispFactor;                     %NH4 diffusion coefficient in non-bioturbated layer (cm2/yr)           
        ...
        function r = calc(obj, bsd, swi, r)
            ...
            rNH4.ls1 = r.zTOC.prepfg_l12(bsd, swi, r, (1-bsd.gamma), (1-bsd.gamma), (1-bsd.gamma), 0, 0, r.zox, obj.DNH41, obj.DNH42);
            % layer 2: zox < z < zno3, passive diffn TODO NH4 from denitrification?
            rNH4.ls2 = r.zTOC.prepfg_l12(bsd, swi, r,    0,                 0,       0,          0,  r.zox, r.zno3, obj.DNH41, obj.DNH42);            
            % layer 3: zno3 < z < zinf, NH4 production
            rNH4.ls3 = r.zTOC.prepfg_l12(bsd, swi, r, bsd.NC1,          bsd.NC2,        bsd.NC3, 0, r.zno3, bsd.zinf, obj.DNH41, obj.DNH42);
            ...
            [ e3_zinf, dedz3_zinf, f3_zinf, dfdz3_zinf, g3_zinf, dgdz3_zinf] ...
                = r.zTOC.calcfg_l12(bsd.zinf, bsd, swi, r, bsd.NC1, bsd.NC2, bsd.NC3, 0, rNH4.ls3);
            ...
            [ e2_zno3, dedz2_zno3, f2_zno3, dfdz2_zno3, g2_zno3, dgdz2_zno3] ...
                = r.zTOC.calcfg_l12(r.zno3, bsd, swi, r,     0,            0, 0, 0, rNH4.ls2);
            % ... and top of layer 3
            [ e3_zno3, dedz3_zno3, f3_zno3, dfdz3_zno3, g3_zno3, dgdz3_zno3] ...1
                = r.zTOC.calcfg_l12(r.zno3, bsd, swi, r, bsd.NC1, bsd.NC2, bsd.NC3, 0, rNH4.ls3);
            ...
            FNH4 = r.zTOC.calcReac(r.zno3, bsd.zinf, bsd.NC1, bsd.NC2, bsd.NC3, bsd, swi, r); % MULTIPLY BY 1/POR ????
            % basis functions at bottom of layer 1
            [ e1_zox, dedz1_zox, f1_zox, dfdz1_zox, g1_zox, dgdz1_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, (1-bsd.gamma), (1-bsd.gamma), (1-bsd.gamma), 0, rNH4.ls1);
            % basis functions at top of layer 2
            [ e2_zox, dedz2_zox, f2_zox, dfdz2_zox, g2_zox, dgdz2_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, 0, 0, 0, 0, rNH4.ls2);
            ...
            [ e1_0, dedz1_0, f1_0, dfdz1_0, g1_0, dgdz1_0] ...
                = r.zTOC.calcfg_l12(0, bsd, swi, r, 0, 0, 0, 0, rNH4.ls1);
            % transform to use coeffs from l3
        ...
        function [NH4, flxNH4] = calcNH4(obj, z, bsd, swi, r)
            ...
            rNH4 = r.rNH4;
                ...
                if z <= r.zox   % layer 1
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0, 0, 0, 0, rNH4.ls1);
                    NH4     = r.rNH4.A1.*e + r.rNH4.B1.*f + g;
                    flxNH4  = D.*(r.rNH4.A1.*dedz+r.rNH4.B1.*dfdz + dgdz);
                elseif z <= r.zno3 % layer 2
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0, 0, 0, 0, rNH4.ls2);
                    NH4     = r.rNH4.A2.*e + r.rNH4.B2.*f + g;
                    flxNH4  = D.*(r.rNH4.A2.*dedz+r.rNH4.B2.*dfdz + dgdz);
                else
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, bsd.gamma.*bsd.NC1, bsd.gamma.*bsd.NC2, bsd.gamma.*bsd.NC3, 0, rNH4.ls3);
