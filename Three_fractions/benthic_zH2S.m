...
classdef benthic_zH2S
    ...
    methods
        ...
        function r = calc(obj, bsd, swi, r)
            ...
            %      ls =      prepfg_l12( bsd, swi, r, reac1,     reac2,     reac3,     ktemp, zU, zL, D1,        D2)
            rH2S.ls1 = r.zTOC.prepfg_l12(bsd, swi, r, 0,         0,         0,         0,     0, r.zox, obj.DH2S1, obj.DH2S2);
            % layer 2: zox < z < zno3, passive diffn
            rH2S.ls2 = r.zTOC.prepfg_l12(bsd, swi, r, 0,         0,         0,         0,  r.zox, r.zno3, obj.DH2S1, obj.DH2S2);            
            % layer 3: zno3 < z < zso4, H2S consumption by OM oxidation
            rH2S.ls3 = r.zTOC.prepfg_l12(bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, r.zno3, r.zso4, obj.DH2S1, obj.DH2S2);
            % layer 4: zso4 < z < zinf, passive diffn
            rH2S.ls4 = r.zTOC.prepfg_l12(bsd, swi, r, 0,         0,         0,         0, r.zso4, bsd.zinf, obj.DH2S1, obj.DH2S2);
            ...
            [ e4_zinf, dedz4_zinf, f4_zinf, dfdz4_zinf, g4_zinf, dgdz4_zinf] ...
                = r.zTOC.calcfg_l12(bsd.zinf, bsd, swi, r, 0, 0, 0, 0, rH2S.ls4);
            ...
            [ e3_zso4, dedz3_zso4, f3_zso4, dfdz3_zso4, g3_zso4, dgdz3_zso4] ...
                = r.zTOC.calcfg_l12(r.zso4, bsd, swi, r,  obj.reac1, obj.reac2, obj.reac3, 0, rH2S.ls3);
            % ... and top of layer 4
            [ e4_zso4, dedz4_zso4, f4_zso4, dfdz4_zso4, g4_zso4, dgdz4_zso4] ...1
                = r.zTOC.calcfg_l12(r.zso4, bsd, swi, r,  0,  0, 0, 0, rH2S.ls4);
            %flux of H2S produced by AOM interface (Source of H2S)   
            zso4FH2S = r.zTOC.calcReac(r.zso4, bsd.zinf, bsd.SO4C, bsd.SO4C, bsd.SO4C, bsd, swi, r); % MULTIPLY BY 1/POR ????
            ...
            [ e2_zno3, dedz2_zno3, f2_zno3, dfdz2_zno3, g2_zno3, dgdz2_zno3] ...
                = r.zTOC.calcfg_l12(r.zno3, bsd, swi, r,     0,            0,            0, 0, rH2S.ls2);
            % ... and top of layer 3
            [ e3_zno3, dedz3_zno3, f3_zno3, dfdz3_zno3, g3_zno3, dgdz3_zno3] ...1
                = r.zTOC.calcfg_l12(r.zno3, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, rH2S.ls3);
            ...
            zoxFH2S = r.zTOC.calcReac(r.zno3, bsd.zinf, bsd.SO4C, bsd.SO4C, bsd.SO4C, bsd, swi, r); % MULTIPLY BY 1/POR ????
            % basis functions at bottom of layer 1
            [ e1_zox, dedz1_zox, f1_zox, dfdz1_zox, g1_zox, dgdz1_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, 0, 0, 0, 0, rH2S.ls1);
            % basis functions at top of layer 2
            [ e2_zox, dedz2_zox, f2_zox, dfdz2_zox, g2_zox, dgdz2_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, 0, 0, 0, 0, rH2S.ls2);
            ...
            [ e1_0, dedz1_0, f1_0, dfdz1_0, g1_0, dgdz1_0] ...
                = r.zTOC.calcfg_l12(0, bsd, swi, r, 0, 0, 0, 0, rH2S.ls1);
            % transform to use coeffs from l4
        ...
        function [H2S, flxH2S] = calcH2S(obj, z, bsd, swi, r)
            ...
            if z <= r.zox   % layer 1
                [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0, 0, 0, 0, rH2S.ls1);
                H2S     = r.rH2S.A1.*e + r.rH2S.B1.*f + g;
                flxH2S  = D.*(r.rH2S.A1.*dedz+r.rH2S.B1.*dfdz + dgdz);
            elseif z <= r.zno3 % layer 2
                [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0, 0, 0, 0, rH2S.ls2);
                H2S     = r.rH2S.A2.*e + r.rH2S.B2.*f + g;
                flxH2S  = D.*(r.rH2S.A2.*dedz+r.rH2S.B2.*dfdz + dgdz);
            elseif z <= r.zso4
                [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, obj.reac1, obj.reac2, obj.reac3, 0, rH2S.ls3);
                H2S     = r.rH2S.A3.*e + r.rH2S.B3.*f + g;
                flxH2S  = D.*(r.rH2S.A3.*dedz+r.rH2S.B3.*dfdz + dgdz);
            else
                [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, 0,   0,    0 , 0, rH2S.ls4);
