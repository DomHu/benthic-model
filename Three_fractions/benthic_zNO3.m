...
classdef benthic_zNO3
    ...
    methods
        ...
        function [flxzno3, conczno3, flxswi,r] = calcbc(obj, zno3, bsd, swi, r, bctype)
            ...
            rNO3.ls1 = r.zTOC.prepfg_l12(bsd, swi, r, bsd.gamma.*bsd.NC1, bsd.gamma.*bsd.NC2, bsd.gamma.*bsd.NC3, 0,  0, r.zox, obj.DN1, obj.DN2);
            % layer 2: zox < z < zno3, denitrification
            rNO3.ls2 = r.zTOC.prepfg_l12(bsd, swi, r, -bsd.NO3CR,       -bsd.NO3CR,         -bsd.NO3CR,         0,  r.zox, zno3, obj.DN1, obj.DN2);            
            ...
            [ e2_zno3, dedz2_zno3, f2_zno3, dfdz2_zno3, g2_zno3, dgdz2_zno3] ...
                = r.zTOC.calcfg_l12(zno3, bsd, swi, r,     -bsd.NO3CR,       -bsd.NO3CR,   -bsd.NO3CR, 0, rNO3.ls2);
            ...
            [ e1_zox, dedz1_zox, f1_zox, dfdz1_zox, g1_zox, dgdz1_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, bsd.gamma.*bsd.NC1, bsd.gamma.*bsd.NC2, bsd.gamma.*bsd.NC3, 0, rNO3.ls1);
            % basis functions at top of layer 2
            [ e2_zox, dedz2_zox, f2_zox, dfdz2_zox, g2_zox, dgdz2_zox] ...
                = r.zTOC.calcfg_l12(r.zox, bsd, swi, r, -bsd.NO3CR,       -bsd.NO3CR,  -bsd.NO3CR, 0, rNO3.ls2);
            
            %flux of NH4 to zox  TODO NH4 production by denitrification?
            FNH4 = r.zTOC.calcReac(zno3, bsd.zinf, bsd.NC1, bsd.NC2, bsd.NC3, bsd, swi, r); % MULTIPLY BY 1/POR ????
            ...
            [ e1_0, dedz1_0, f1_0, dfdz1_0, g1_0, dgdz1_0] ...
                = r.zTOC.calcfg_l12(0, bsd, swi, r, bsd.gamma.*bsd.NC1, bsd.gamma.*bsd.NC2, bsd.gamma.*bsd.NC3, 0, rNO3.ls1);
        ...
        function [NO3, flxNO3] = calcNO3(obj, z, bsd, swi, r)
            ...
            if z <= r.zno3
                ...
                if z <= r.zox   % layer 1
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, bsd.gamma.*bsd.NC1, bsd.gamma.*bsd.NC2, bsd.gamma.*bsd.NC3, 0, rNO3.ls1);
                    NO3     = r.rNO3.A1.*e + r.rNO3.B1.*f + g;
                    flxNO3  = D.*(r.rNO3.A1.*dedz+r.rNO3.B1.*dfdz + dgdz);
                elseif z <= r.zno3 % layer 2
                    [ e, dedz, f, dfdz, g, dgdz]  = r.zTOC.calcfg_l12(z, bsd, swi, r, -bsd.NO3CR,       -bsd.NO3CR,    -bsd.NO3CR, 0, rNO3.ls2);
