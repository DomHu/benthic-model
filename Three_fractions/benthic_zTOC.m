...
classdef benthic_zTOC < handle
    ...
    properties
        ...
        k3=0.00001;                                                   %TOC degradation rate constant (1/yr)  
    ...
    methods
        ...
        function res = calc(obj, bsd, swi, res)
            ...
            rTOC.a13=(bsd.w-sqrt(bsd.w.^2+4.*obj.DC1.*obj.k3))./(2.*obj.DC1);
            rTOC.b13=(bsd.w+sqrt(bsd.w.^2+4.*obj.DC1.*obj.k3))./(2.*obj.DC1);
            rTOC.a23=(-obj.k3./bsd.w);
            rTOC.A13=-(swi.C03.*rTOC.b13.*exp(rTOC.b13.*bsd.zbio))./(rTOC.a13.*exp(rTOC.a13.*bsd.zbio)-rTOC.b13.*exp(rTOC.b13.*bsd.zbio));
            rTOC.A23=(rTOC.A13.*(exp(rTOC.a13.*bsd.zbio)-exp(rTOC.b13.*bsd.zbio))+swi.C03.*exp(rTOC.b13.*bsd.zbio))./exp(rTOC.a23.*bsd.zbio);
            ...
            res.F_TOC3=-(1-bsd.por).*bsd.w.*rTOC.A23.*exp(rTOC.a23.*bsd.zinf);
            res.F_TOC=res.F_TOC1+res.F_TOC2+res.F_TOC3;
            
            
        end
        
     
        function [C, C1, C2, C3] = calcC(obj, z, bsd, swi, r)
            % Calculate concentration at depth z from solution
                ...
                if(z<bsd.zbio)
                    ...
                    C3=rTOC.A13.*(exp(rTOC.a13.*z)-exp(rTOC.b13.*z))+swi.C03.*exp(rTOC.b13.*z);
                else                   
                    C1=rTOC.A21.*exp(rTOC.a21.*z);
                    C2=rTOC.A22.*exp(rTOC.a22.*z);
                    C3=rTOC.A23.*exp(rTOC.a23.*z);
                end
                
                C = C1 + C2 + C3;           
        end
        
        function [Cflx, C1flx, C2flx, C3flx] = calcCflx(obj, z, bsd, swi, r)
            % Calculate flux at depth z, from solution
                rTOC = r.rTOC;
                [C, C1, C2, C3] = obj.calcC(z,bsd,swi,r);
                if(z<bsd.zbio)
                    ...
                    dC3dz =  rTOC.A13.*(rTOC.a13.*exp(rTOC.a13.*z)-rTOC.b13.*exp(rTOC.b13.*z))+swi.C03.*rTOC.b13.*exp(rTOC.b13.*z);
                    C3flx = - (1-bsd.por).*(-obj.DC1.*dC3dz + bsd.w.*C3);
                else                   
                    C1flx = - (1-bsd.por).*bsd.w.*C1;
                    C2flx = - (1-bsd.por).*bsd.w.*C2;
                    C3flx = - (1-bsd.por).*bsd.w.*C3;
                end
                
                Cflx = C1flx + C2flx + C3flx;           
        end
        
        function [e, dedz, f, dfdz, g, dgdz] ...
                = calcfg_l1(obj, z, bsd, swi, res, reac1, reac2, reac3, Dtemp, ktemp)
            ...
            PhiI3   =-pfac.*obj.k3.*(reac3).*r.A13./(Dtemp.*r.a13.^2-bsd.w.*r.a13-ktemp);
            PhiII3  = pfac.*obj.k3.*(reac3).*r.A13./(Dtemp.*r.b13.^2-bsd.w.*r.b13-ktemp);
            PhiIII3 =-pfac.*obj.k3.*(reac3).*swi.C03./(Dtemp.*r.b13.^2-bsd.w.*r.b13-ktemp);
            ...
            g =  PhiI1.*ea11z + PhiII1.*eb11z + PhiIII1.*eb11z + ...
                ...
                PhiI3.*ea13z + PhiII3.*eb13z + PhiIII3.*eb13z;
            
           
            dgdz = PhiI1.*r.a11.*ea11z + PhiII1.*r.b11.*eb11z + PhiIII1.*r.b11.*eb11z + ...
                PhiI2.*r.a12.*ea12z + PhiII2.*r.b12.*eb12z + PhiIII2.*r.b12.*eb12z  + ...
                PhiI3.*r.a13.*ea13z + PhiII3.*r.b13.*eb13z + PhiIII3.*r.b13.*eb13z;
                       
            
        end
        function [ e, dedz, f, dfdz, g, dgdz] ...
                = calcfg_l2(obj, z, bsd, swi, res, reac1, reac2, reac3, Dtemp, ktemp)
            % Basis functions for solutes, case z > zbio
            % reac1, reac2        - mol/mol S released per organic carbon C
            %
            % General solution for solute S is given by 
            ...
            PhiI3 = -pfac.*obj.k3.*(reac3).*r.A23./(Dtemp.*r.a23.^2-bsd.w.*r.a23-ktemp);
        ...
        function [ e, dedz, f, dfdz, g, dgdz] ...
                = calcfg_l12(obj, z, bsd, swi, res, reac1, reac2, reac3, ktemp, ls)
...
%                        msg='CASE 1'
                        [e, dedz, f, dfdz, g, dgdz] ...
                            = obj.calcfg_l1( z, bsd, swi, res, reac1, reac2, reac3, ls.D1, ktemp);
                    case 2 % not bioturbated
%                        msg='CASE 2'
                        [ e, dedz, f, dfdz, g, dgdz] ...
                            = obj.calcfg_l2( z, bsd, swi, res, reac1, reac2, reac3, ls.D2, ktemp);
...
%                            msg = 'crossing boundary - ELSEEE'
        ...
        function ls = prepfg_l12(obj, bsd, swi, res, reac1, reac2, reac3, ktemp, zU, zL, D1, D2)
            ...
            if bsd.usescalarcode
                ...
                elseif zU >= bsd.zbio % wholly within non-bioturbated layer
                    ...
                    [e_zbio_l1, dedz_zbio_l1, f_zbio_l1, dfdz_zbio_l1, g_zbio_l1, dgdz_zbio_l1] ...
                        = obj.calcfg_l1(bsd.zbio, bsd, swi, res, reac1, reac2, reac3, ls.D1, ktemp);
                    [e_zbio_l2, dedz_zbio_l2, f_zbio_l2, dfdz_zbio_l2, g_zbio_l2, dgdz_zbio_l2] ...
                        = obj.calcfg_l2(bsd.zbio, bsd, swi, res, reac1, reac2, reac3, ls.D2, ktemp);
        ...
        function FReac = calcReac(obj, zU, zL, reac1, reac2, reac3, bsd, swi, res)
            ...
            FReac=obj.calcReac_l1(min(zU,bsd.zbio), min(zL,bsd.zbio), reac1, reac2, reac3, bsd, swi, res) ...
                + obj.calcReac_l2(max(zU,bsd.zbio), max(zL, bsd.zbio), reac1, reac2, reac3, bsd, swi, res);
                       
                                          
            % TODO confirm (1-bsd.por).*  has been added (to k1 & k2 ?)
        end
        
        function FReac1 = calcReac_l1(obj, zU, zL, reac1, reac2, reac3, bsd, swi, res)
            ...
            FReac1 =-reacf1.*(r.A11.*(exp(r.a11.*zU).*r.b11 - exp(r.b11.*zU).*r.a11 - exp(r.a11.*zL).*r.b11 + exp(r.b11.*zL).*r.a11)...
                ...
                +swi.C02.*exp(r.b12.*zU).*r.a12 -swi.C02.*exp(r.b12.*zL).*r.a12)./(r.a12.*r.b12)  ...
                    -reacf3.*(r.A13.*(exp(r.a13.*zU).*r.b13 - exp(r.b13.*zU).*r.a13 - exp(r.a13.*zL).*r.b13 + exp(r.b13.*zL).*r.a13) ... 
                +swi.C03.*exp(r.b13.*zU).*r.a13 -swi.C03.*exp(r.b13.*zL).*r.a13)./(r.a13.*r.b13);
        end
        
        function FReac2 = calcReac_l2(obj, zU, zL, reac1, reac2, reac3, bsd, swi, res)
            ...
            FReac2= -reacf1.*r.A21.*(exp(r.a21.*zU) - exp(r.a21.*zL))./r.a21...
                    ...
                    -reacf3.*r.A23.*(exp(r.a23.*zU) - exp(r.a23.*zL))./r.a23;
        end
        ...
        function [e_P, dedz_P, f_P, dfdz_P, g_P, dgdz_P, p_P, dpdz_P, q_P, dqdz_P,...
                ...
                = calcfg_l12_PO4_M(obj, z, bsd, swi, res, reac1P, reac2P,  reac3P, ktempP, QtempP, alphaP, ls, ktempM, QtempM, alphaM)
            % calculate solution basis functions, for layer which may cross bioturbation boundary
            %
            % reac1, reac2        - mol/mol S released per organic carbon C
            %
                    ...
                    case 1  % bioturbated
                        if(alphaP==0)  % was z<=res.zox oxic layer -> call PO4 first
                            [e_P, dedz_P, f_P, dfdz_P, g_P, dgdz_P, p_P, dpdz_P, q_P, dqdz_P, a1_P, b1_P, Phi1_P] ...
                                = obj.calcfg_l1_PO4( z, bsd, swi, res, reac1P, reac2P, reac3P, ls.D1P, ktempP, QtempP, 0,0, alphaP);
                            ...
                            = obj.calcfg_l1_PO4(z, bsd, swi, res, reac1P, reac2P, reac3P, ls.D1P, ktempP, QtempP, a1_M, b1_M, alphaP);
                        end
                        
                    case 2 % not bioturbated
                        if(alphaP==0)  % was z<=res.zox oxic layer -> call PO4 first
                            [e_P, dedz_P, f_P, dfdz_P, g_P, dgdz_P, p_P, dpdz_P, q_P, dqdz_P, a2_P, b2_P, Phi2_P] ...
                            = obj.calcfg_l2_PO4(z, bsd, swi, res, reac1P, reac2P, reac3P, ls.D2P, ktempP, QtempP, 0, alphaP);                            
                            ...
                            [e_P, dedz_P, f_P, dfdz_P, g_P, dgdz_P, p_P, dpdz_P, q_P, dqdz_P, a2_P, b2_P, Phi2_P] ...
                            = obj.calcfg_l2_PO4(z, bsd, swi, res, reac1P, reac2P, reac3P, ls.D2P, ktempP, QtempP, a2_M, alphaP);
                        end                     
                    ...
                    case 3 % crossing boundary                        
                        if z > bsd.zbio  % not bioturbated region
                            ...
                            if(alphaP==0)  % was z<=res.zox oxic layer -> call PO4 first
                                ...
                                [e_M_1, dedz_M_1, f_M_1, dfdz_M_1, g_M_1, dgdz_M_1, p_M_1, dpdz_M_1, q_M_1, dqdz_M_1, a1_M, b1_M] ...
                                    = obj.calcfg_l1_M(z, bsd, swi, res, ls.D1M, ktempM, QtempM, 0, 0, 0, alphaM);
                                [e_P_1, dedz_P_1, f_P_1, dfdz_P_1, g_P_1, dgdz_P_1, p_P_1, dpdz_P_1, q_P_1, dqdz_P_1, a1_M, b1_P, Phi1_P] ...
                                    = obj.calcfg_l1_PO4(z, bsd, swi, res, reac1P, reac2P, reac3P, ls.D1P, ktempP, QtempP, a1_M, b1_M, alphaP);                                
                            end
        ...
        % CHECK/TODO: OR SHALL I RATHER LEAVE THE VALUESIN MATRICES???? OR
        ...
        function ls = prepfg_l12_PO4_M(obj, bsd, swi, res, reac1, reac2, reac3, ktempP, QtempP, zU, zL, D1P, D2P, alphaP, ...
                    ...
                    if(zL<=res.zox)   % oxic layer -> call PO4 first  DOMINIK: TODO: MAYBE HERE ALSO ask alphaP~=0!?
                        [e_zbio_l1_P, dedz_zbio_l1_P, f_zbio_l1_P, dfdz_zbio_l1_P, g_zbio_l1_P, ...
                         dgdz_zbio_l1_P, p_zbio_l1_P, dpdz_zbio_l1_P, q_zbio_l1_P, dqdz_zbio_l1_P, a1_P, b1_P, Phi1_P] ...
                            = obj.calcfg_l1_PO4(bsd.zbio, bsd, swi, res, reac1, reac2, reac3, ls.D1P, ktempP, QtempP, 0,0, alphaP);
                        ...
                        [e_zbio_l2_P, dedz_zbio_l2_P, f_zbio_l2_P, dfdz_zbio_l2_P, g_zbio_l2_P, ...
                            ...
                            = obj.calcfg_l2_PO4(bsd.zbio, bsd, swi, res, reac1, reac2, reac3, ls.D2P, ktempP, QtempP, 0, alphaP);
                        ...
                        [e_zbio_l1_P, dedz_zbio_l1_P, f_zbio_l1_P, dfdz_zbio_l1_P, g_zbio_l1_P, ...
                         dgdz_zbio_l1_P, p_zbio_l1_P, dpdz_zbio_l1_P, q_zbio_l1_P, dqdz_zbio_l1_P, a1_P, b1_P, Phi1_P] ...
                            = obj.calcfg_l1_PO4(bsd.zbio, bsd, swi, res, reac1, reac2, reac3, ls.D1P, ktempP, QtempP, a1_M, b1_M, alphaP);
                        
                        [e_zbio_l2_P, dedz_zbio_l2_P, f_zbio_l2_P, dfdz_zbio_l2_P, g_zbio_l2_P, ...
                            dgdz_zbio_l2_P, p_zbio_l2_P, dpdz_zbio_l2_P, q_zbio_l2_P, dqdz_zbio_l2_P, a2_P, b2_P, Phi2_P] ...
                            = obj.calcfg_l2_PO4(bsd.zbio, bsd, swi, res, reac1, reac2, reac3, ls.D2P, ktempP, QtempP, a2_M, alphaP);
...
%            pfac = 1;          % in fact, already has (1-por)/por                
       ...
       % this is when M is dependent!
                ...
                g = Phi1_P.PhiI1/(Dtemp.*ea11z.^2-bsd.w.*ea11z-ktemp).*exp(z.*ea11z) + Phi1_P.PhiII1/(Dtemp.*eb11z.^2-bsd.w.*eb11z-ktemp).*exp(z.*eb11z) + ...
                    ...
                    Phi1_P.PhiI3/(Dtemp.*ea13z.^2-bsd.w.*ea13z-ktemp).*exp(z.*ea13z) + Phi1_P.PhiII3/(Dtemp.*eb13z.^2-bsd.w.*eb13z-ktemp).*exp(z.*eb13z) + ...
                    Phi1_P.PhiIII3/(Dtemp.*eb13z.^2-bsd.w.*eb13z-ktemp).*exp(z.*eb13z);
                ...
                dgdz = Phi1_P.PhiI1/(Dtemp.*ea11z.^2-bsd.w.*ea11z-ktemp).*exp(z.*ea11z).*ea11z + Phi1_P.PhiII1/(Dtemp.*eb11z.^2-bsd.w.*eb11z-ktemp).*exp(z.*eb11z).*eb11z + ...
                    ...
                    Phi1_P.PhiI3/(Dtemp.*ea13z.^2-bsd.w.*ea13z-ktemp).*exp(z.*ea13z).*ea13z + Phi1_P.PhiII3/(Dtemp.*eb13z.^2-bsd.w.*eb13z-ktemp).*exp(z.*eb13z).*eb13z + ...
                    Phi1_P.PhiIII3/(Dtemp.*eb13z.^2-bsd.w.*eb13z-ktemp).*exp(z.*eb13z).*eb13z;                
...
%                pfac = 1;          % in fact, already has (1-por)/por
        ...
        function [e, dedz, f, dfdz, g, dgdz, p, dpdz, q, dqdz, a1, b1, Phi1] ...
                = calcfg_l1_PO4(obj, z, bsd, swi, res, reac1, reac2, reac3, Dtemp, ktemp, Qtemp, a1_M, b1_M, alpha)
            % Basis functions for solutes, case z <= zbio
            %
            % reac1, reac2        - mol./mol S released per organic carbon C
            % depend1,   depend2 coming from other species
            ...
            Phi1.PhiI3   =-pfac.*obj.k3.*(reac3).*r.A13./(Dtemp.*r.a13.^2-bsd.w.*r.a13-ktemp);
            Phi1.PhiII3  = pfac.*obj.k3.*(reac3).*r.A13./(Dtemp.*r.b13.^2-bsd.w.*r.b13-ktemp);
            Phi1.PhiIII3 =-pfac.*obj.k3.*(reac3).*swi.C03./(Dtemp.*r.b13.^2-bsd.w.*r.b13-ktemp);
            ...
            if(ktemp==0) % CHECK: actually no need as ktemp always <> 0
                g =  Phi1.PhiI1.*ea11z + Phi1.PhiII1.*eb11z + Phi1.PhiIII1.*eb11z + ...
                     ...
                     Phi1.PhiI3.*ea13z + Phi1.PhiII3.*eb13z + Phi1.PhiIII3.*eb13z;
            else
                g =  Phi1.PhiI1.*ea11z + Phi1.PhiII1.*eb11z + Phi1.PhiIII1.*eb11z + ...
                     Phi1.PhiI2.*ea12z + Phi1.PhiII2.*eb12z + Phi1.PhiIII2.*eb12z + ...
                     Phi1.PhiI3.*ea13z + Phi1.PhiII3.*eb13z + Phi1.PhiIII3.*eb13z + Qtemp./ktemp;   % here problem if ktemp=0
            end
            dgdz = Phi1.PhiI1.*r.a11.*ea11z + Phi1.PhiII1.*r.b11.*eb11z + Phi1.PhiIII1.*r.b11.*eb11z + ...
                   ...
                   Phi1.PhiI3.*r.a13.*ea13z + Phi1.PhiII3.*r.b13.*eb13z + Phi1.PhiIII3.*r.b13.*eb13z;     
...
% % % %                 dqdz = dfdz;
        ...
        function [ e, dedz, f, dfdz, g, dgdz, p, dpdz, q, dqdz, a2, b2, Phi2] ...
                = calcfg_l2_PO4(obj, z, bsd, swi, res, reac1, reac2, reac3, Dtemp, ktemp, Qtemp, a2_M, alpha)
            % Basis functions for solutes, case z > zbio
            % reac1, reac2        - mol/mol S released per organic carbon C
            %
            % General solution for solute S is given by 
...
% % % % %          OLD NO NEED FOR ANYMORE? !? IF IT STILL RUNS
% % % % %         function [ e, dedz, f, dfdz, g, dgdz] ...
% % % % %                 = calcfg_l12_PO4(obj, z, bsd, swi, res, reac1, reac2, ktemp, Qtemp, ls, alpha)
% % % % %             % calculate solution basis functions, for layer which may cross bioturbation boundary
% % % % %             %
% % % % %             % reac1, reac2        - mol/mol S released per organic carbon C
% % % % %             %
...
% % % % %                     case 1  % bioturbated
% % % % % %                        msg='CASE 1'
% % % % %                         [e, dedz, f, dfdz, g, dgdz, p, dpdz, q, dqdz, a1, b1, Phi] ...
% % % % %                             = obj.calcfg_l1_PO4( z, bsd, swi, res, reac1, reac2, ls.D1, ktemp, Qtemp, ls_old, alpha);
% % % % %                     case 2 % not bioturbated
% % % % % %                        msg='CASE 2'
% % % % %                         [ e, dedz, f, dfdz, g, dgdz, p, dpdz, q, dqdz, a2, b2, Phi] ...
% % % % %                             = obj.calcfg_l2_PO4( z, bsd, swi, res, reac1, reac2, ls.D2, ktemp, Qtemp, ls_old, alpha);
% % % % %                     case 3 % crossing boundary
% % % % %                         if z >= bsd.zbio  % below bioturbated regio
% % % % % %                            msg = 'crossing boundary - IFFFFFF'
% % % % %                             [e, dedz, f, dfdz, g, dgdz, p, dpdz, q, dqdz, a2, b2, Phi] ...
...
% % % % %                         else   % above bioturbated region
% % % % % %                            msg = 'crossing boundary - ELSEEE'
% % % % %                             [e_1, dedz_1, f_1, dfdz_1, g_1, dgdz_1, p, dpdz, q, dqdz, a1, b1, Phi] ...
% % % % %                                 = obj.calcfg_l1_PO4( z, bsd, swi, res, reac1, reac2, ls.D1, ktemp, Qtemp, ls_old, alpha);
% % % % %                             
% % % % %                             % Now find 'transformed' basis functions such that in layer 1, O2 = A_2*et + B_2*ft + gt  (ie layer 1 soln written in terms of layer 2 coeffs A_2, B_2)
% % % % %                             [e, f, g, dedz, dfdz, dgdz] = benthic_utils.xformsoln(e_1, f_1, g_1, dedz_1, dfdz_1, dgdz_1, ...
