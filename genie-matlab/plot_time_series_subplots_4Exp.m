...
REF_sed_Ca_exp1 = load(fullfile(exp_1,'/biogem/biogem_series_ocn_Ca.res'),'ascii');
REF_sed_Ca_exp2 = load(fullfile(exp_2,'/biogem/biogem_series_ocn_Ca.res'),'ascii');
REF_sed_Ca_exp3 = load(fullfile(exp_3,'/biogem/biogem_series_ocn_Ca.res'),'ascii');
REF_sed_Ca_exp4 = load(fullfile(exp_4,'/biogem/biogem_series_ocn_Ca.res'),'ascii');
