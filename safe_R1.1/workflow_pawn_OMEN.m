...
save('RESULTS_PAWN/Xu_PO4_4000_noK.mat','Xu')
save('RESULTS_PAWN/Yu_PO4_4000_noK.mat','Yu')
...
save('RESULTS_PAWN/XX_PO4_4000_noK.mat','XX')
save('RESULTS_PAWN/xc_PO4_4000_noK.mat','xc')

YY = pawn_model_evaluation(fun_test,XX,res) ;
save('RESULTS_PAWN/YY_PO4_4000_noK.mat','YY')
...
title(Titles(j))
print('-depsc2', ['RESULTS_PAWN/KS_PO4_4000m_noK' char(Titles(j)) '.eps']);
...
title(Titles(j))
print('-depsc2', ['RESULTS_PAWN/SIndex_PO4_4000m_noK' char(Titles(j)) '.eps']);
...
title(Titles(j))
print('-depsc2', ['RESULTS_PAWN/Conv_PO4_4000m_noK' char(Titles(j)) '.eps']);
...
%save('RESULTS_PAWN/SIndex_PO4_400m.mat','SIndex')
