...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            %%%%    Station 6: OMZ water depth 250m
            
            %sediment characteristics
            bsd.rho_sed=2.0; %was 2.5                           % sediment density (g/cm3)
            bsd.wdepth=250.0;     % Dom was 600.0                       % water depth (m)
            ...
            swi.C02= 14*1e-2/12*bsd.rho_sed; % adjusted Test2+4: 6.5* Test5: 190* Dom was 0.06*1e-2/12*bsd.rho_sed;                                %TOC concentration at SWI (wt%) -> (mol/cm^3 bulk phase)
            ...
            swi.NO30=19.0e-9;             % was 20.0e-9      %NO3 concentration at SWI (mol/cm^3)
            swi.Nitrogen=true;
            swi.NH40=1.5e-9;                                                %NH4 concentration at SWI (mol/cm^3)
...
%                ylabel('Depth (cm)')
    %            title ('NH4 (mol/cm^3)')
                ...
                plot(SO4, -zgrid, 'b')
                hold on
                scatter(data.SO4(:,2).*1e-6, -data.SO4(:,1),'k','filled')
