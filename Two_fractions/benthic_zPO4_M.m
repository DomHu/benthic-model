classdef benthic_zPO4_M
    ...
    properties                      
       ...
       % ksPO4=1e-15;
        %kmPO4= 1e-15 ;
        kmPO4=0.05; %2.2e-6*24*365;          % Dom was from Slomp 0.00053*365;	%Rate constant for Fe-bound P release upon Fe oxide reduction   DOM: was 1.8e-6 Slomp ea 1996 0.00053*365 
        %kaPO4 = 0.0;
        ...
        %Minf = 0;
        Minf=2.0e-9; %1.0e-10;       % asymptotic concentration for Fe-bound P (mol/cm3)      TODO/CHECK: good value? is from Slomp et al. 1996 Dom was 1.99e-6
