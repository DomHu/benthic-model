classdef benthic_zPO4_M
    ...
    properties
        ...
        ksPO4=36.5; %7.3; % 3.65 0.26*365;           	% Rate constant for kinetic P sorption (1/yr) (Palastanga: 3.65;)
...
%        kmPO4= 1e-15 ;
%        kaPO4 = 0.0;
        PO4s=2.0e-9; %12.0e-9 (DH: is too high, get devrease and also negative [PO4] in oxic layer); % 10.0e-10;              % Equilibrium concentration for P sorption (mol/cm3)       was 1.5e-9; ; Slomp ea 1996
        PO4a= 3.7e-9; % 3.7e-9;                % Equilibrium concentration for authigenic P formation (mol/cm3) was 0.7e-9
        Minf=5.2e-15; % 0.0; 5.2e-9; %1.99e-10; %2.0e-9; %1.0e-10;       % asymptotic concentration for Fe-bound P (mol/cm3)  (was 5.2e-9;)
        %Minf = 0;
