...
% %             % change SWI concentration if boundary is bioturbated
% %             if(bsd.zbio>0.0)    
% %                 % calculate fluxes from old concentration, assuming no
% %                 % bioturbation
% %             	Fnonbio1 =swi.C01.*(1-bsd.por).*bsd.w;
% %                 swi.C01 = (Fnonbio1*(-rTOC.a11*exp(rTOC.a11*bsd.zbio)+rTOC.b11*exp(rTOC.b11*bsd.zbio)))/(-obj.DC1*rTOC.b11*rTOC.a11*exp(rTOC.b11*bsd.zbio)+obj.DC1*rTOC.b11*rTOC.a11*exp(rTOC.a11*bsd.zbio) ...
...
% %                 % calculate fluxes from old concentration, assuming no
% %                 % bioturbation
% %              	Fnonbio2 =swi.C02.*(1-bsd.por).*bsd.w;
% %                 swi.C02 = (Fnonbio2*(-rTOC.a12*exp(rTOC.a12*bsd.zbio)+rTOC.b12*exp(rTOC.b12*bsd.zbio)))/(-obj.DC1*rTOC.b12*rTOC.a12*exp(rTOC.b12*bsd.zbio)+obj.DC1*rTOC.b12*rTOC.a12*exp(rTOC.a12*bsd.zbio) ...
