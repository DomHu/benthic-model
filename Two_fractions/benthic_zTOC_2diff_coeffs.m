classdef benthic_zTOC < handle
    ...
    properties
        ...
        k1= 4.0; %0.035; % 0.01 0.006;                                                  %TOC degradation rate constnat (1/yr)
        k2= 4.0;   %0.0006;                                                %TOC degradation rate constant (1/yr)  
    ...
    methods
        ...
        function res = calc(obj, bsd, swi, res)
            ...
            rTOC.a21=(bsd.w-sqrt(bsd.w.^2+4.*obj.DC2.*obj.k1))./(2.*obj.DC2);
        	...
        	rTOC.A11=((obj.DC2.*rTOC.a21-obj.DC1.*rTOC.b11).*(swi.C01.*exp(rTOC.b11.*bsd.zbio)))./(obj.DC1.*(rTOC.a11.*exp(rTOC.a11.*bsd.zbio)-rTOC.b11.*exp(rTOC.b11.*bsd.zbio))-obj.DC2.*rTOC.a21.*(exp(rTOC.a11.*bsd.zbio)-exp(rTOC.b11.*bsd.zbio)));
            ...
            rTOC.a22=(bsd.w-sqrt(bsd.w.^2+4.*obj.DC2.*obj.k2))./(2.*obj.DC2);
            % calculate bioturbated SWI
            ...
            rTOC.A12=((obj.DC2.*rTOC.a22-obj.DC1.*rTOC.b12).*(swi.C02.*exp(rTOC.b12.*bsd.zbio)))./(obj.DC1.*(rTOC.a12.*exp(rTOC.a12.*bsd.zbio)-rTOC.b12.*exp(rTOC.b12.*bsd.zbio))-obj.DC2.*rTOC.a22.*(exp(rTOC.a12.*bsd.zbio)-exp(rTOC.b12.*bsd.zbio)));
