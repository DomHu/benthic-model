...
!   call OMEN-SED from coupled pelagic, biogeochemical model as e.g.:
...
!        print*,'dum_i, dum_j, dum_D ', dum_i, dum_j, dum_D
        ...
        ! w from GENIE
        loc_sed_burial = 1/(1-por)*dum_sed_OM_bur                               ! actual burial rate from previous time-step
...
!                                print*,'loc_new_sed(is_POM_S)', loc_new_sed(is_POM_S)
    ...
    SUBROUTINE sub_huelseetal2016_initialize(dum_D, dum_TempK, dum_depos_rate)
        ...
        NC1=0.0 !16.0/106.0*SD                                  ! N/C first TOC fraction (mol/mol)
        NC2=0.0 !16.0/106.0*SD                                  ! N/C second TOC fraction (mol/mol)
        ...
        w = dum_depos_rate              ! sedimentation rate, cm/yr / burial velocity / advection (from cGENIE)
    ...
    SUBROUTINE sub_huelseetal2016_zO2_calcbc(dum_D, zox, bctype, flxzox, conczox, flxswi,r_zxf)
        ...
        (flxswi /= flxswi)) then !check for NaN if then give value as in matlab.....
            print*,' '
            print*,' '
            print*,'------ zO2_calcbc --------- flxzox is INF', dum_D
