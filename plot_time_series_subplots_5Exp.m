...
% set experiment 
exp_1 = './cgenie_output/EXAMPLE05.worbe2.S36x36_Corg.OPEN_0711_WITH_OMEN-all-remin';
exp_1_extra = './cgenie_output/EXAMPLE05.worbe2.S36x36_Corg_all_remin.OPEN_0811_FROM_SPIN';  % because this exp always stops after 1krs
exp_2 = './cgenie_output/EXAMPLE05.worbe2.S36x36_Corg_ksmaller.OPEN_0811';
exp_3 = './cgenie_output/EXAMPLE05.worbe2.S36x36_Corg.OPEN.SPIN10kyrs_0711_NO-OMEN';
exp_4 = './cgenie_output/EXAMPLE.worbe2.S36x36_Corg.SPIN';
exp_5 = './cgenie_output/EXAMPLE05.worbe2.S36x36_Corg_all_remin.OPEN_1511';
% %%%% load other data

REF_sed_O2_allremin = load(fullfile(exp_1,'/biogem/biogem_series_ocn_O2.res'),'ascii');
REF_sed_O2_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_ocn_O2.res'),'ascii');
...
REF_sed_O2_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_ocn_O2.res'),'ascii');

REF_sed_SO4_allremin = load(fullfile(exp_1,'/biogem/biogem_series_ocn_SO4.res'),'ascii');
REF_sed_SO4_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_ocn_SO4.res'),'ascii');
...
REF_sed_SO4_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_ocn_SO4.res'),'ascii');

REF_sed_H2S_allremin = load(fullfile(exp_1,'/biogem/biogem_series_ocn_H2S.res'),'ascii');
REF_sed_H2S_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_ocn_H2S.res'),'ascii');
...
REF_sed_H2S_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_ocn_H2S.res'),'ascii');

REF_sed_PO4_allremin = load(fullfile(exp_1,'/biogem/biogem_series_ocn_PO4.res'),'ascii');
REF_sed_PO4_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_ocn_PO4.res'),'ascii');
...
REF_sed_PO4_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_ocn_H2S.res'),'ascii');

REF_sed_ALK_allremin = load(fullfile(exp_1,'/biogem/biogem_series_ocn_ALK.res'),'ascii');
REF_sed_ALK_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_ocn_ALK.res'),'ascii');
...
REF_sed_ALK_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_ocn_ALK.res'),'ascii');

REF_sed_DIC_allremin = load(fullfile(exp_1,'/biogem/biogem_series_ocn_DIC.res'),'ascii');
REF_sed_DIC_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_ocn_DIC.res'),'ascii');
...
REF_sed_DIC_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_ocn_DIC.res'),'ascii');
...
%plot(REF_sed_O2_allremin(:,1),REF_sed_O2_allremin(:,3)*1e+6,'b',REF_sed_O2_smallerk(:,1),REF_sed_O2_smallerk(:,3)*1e+6,'r',REF_sed_O2_SPIN(:,1),REF_sed_O2_SPIN(:,3)*1e+6,'k:'); 
...
plot(REF_sed_O2_allremin_1511(:,1),REF_sed_O2_allremin_1511(:,3)*1e+6,'m',REF_sed_O2_allremin(:,1),REF_sed_O2_allremin(:,3)*1e+6,'b',REF_sed_O2_smallerk(:,1),REF_sed_O2_smallerk(:,3)*1e+6,'r',REF_sed_O2_NoOMEN(:,1),REF_sed_O2_NoOMEN(:,3)*1e+6,'g--',REF_sed_O2_SPIN(:,1),REF_sed_O2_SPIN(:,3)*1e+6,'k:'); 
xlabel('yrs ');
...
%plot(REF_sed_SO4_allremin(:,1),REF_sed_SO4_allremin(:,3)*1e+6,'b',REF_sed_SO4_smallerk(:,1),REF_sed_SO4_smallerk(:,3)*1e+6,'r',REF_sed_SO4_NoOMEN(:,1),REF_sed_SO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_SO4_SPIN(:,1),REF_sed_SO4_SPIN(:,3)*1e+6,'k:' ); 
%plot(REF_sed_SO4_allremin(:,1),REF_sed_SO4_allremin(:,3)*1e+6,'b',REF_sed_SO4_smallerk(:,1),REF_sed_SO4_smallerk(:,3)*1e+6,'r',REF_sed_SO4_NoOMEN(:,1),REF_sed_SO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_SO4_SPIN(:,1),REF_sed_SO4_SPIN(:,3)*1e+6,'k:'); 
plot(REF_sed_SO4_allremin_1511(:,1),REF_sed_SO4_allremin_1511(:,3)*1e+6,'m',REF_sed_SO4_allremin(:,1),REF_sed_SO4_allremin(:,3)*1e+6,'b',REF_sed_SO4_smallerk(:,1),REF_sed_SO4_smallerk(:,3)*1e+6,'r',REF_sed_SO4_NoOMEN(:,1),REF_sed_SO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_SO4_SPIN(:,1),REF_sed_SO4_SPIN(:,3)*1e+6,'k:'); 
xlabel('yrs ');
ylabel('SO_4 (\mumol kg^{-1})');
hleg=legend('OPEN: No CaCO3, OMEN: all remin - No other diss.', 'OPEN: No CaCO3, OMEN: all remin', 'OPEN: No CaCO3, OMEN: smaller k', 'OPEN: No CaCO3, No-OMEN', 'SPIN: Closed with CaCO3 - No OMEN'); 
set(hleg,'FontSize',4);
...
%plot(REF_sed_H2S_allremin(:,1),REF_sed_H2S_allremin(:,3)*1e+6,'b',REF_sed_H2S_smallerk(:,1),REF_sed_H2S_smallerk(:,3)*1e+6,'r',REF_sed_H2S_NoOMEN(:,1),REF_sed_H2S_NoOMEN(:,3)*1e+6,'g--',REF_sed_H2S_SPIN(:,1),REF_sed_H2S_SPIN(:,3)*1e+6,'k:'); 
plot(REF_sed_H2S_allremin_1511(:,1),REF_sed_H2S_allremin_1511(:,3)*1e+6,'m',REF_sed_H2S_allremin(:,1),REF_sed_H2S_allremin(:,3)*1e+6,'b',REF_sed_H2S_smallerk(:,1),REF_sed_H2S_smallerk(:,3)*1e+6,'r',REF_sed_H2S_NoOMEN(:,1),REF_sed_H2S_NoOMEN(:,3)*1e+6,'g--',REF_sed_H2S_SPIN(:,1),REF_sed_H2S_SPIN(:,3)*1e+6,'k:'); 
xlabel('yrs ');
...
%plot(REF_sed_PO4_allremin(:,1),REF_sed_PO4_allremin(:,3)*1e+6,'b',REF_sed_PO4_smallerk(:,1),REF_sed_PO4_smallerk(:,3)*1e+6,'r',REF_sed_PO4_NoOMEN(:,1),REF_sed_PO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_PO4_SPIN(:,1),REF_sed_PO4_SPIN(:,3)*1e+6,'k:'); 
plot(REF_sed_PO4_allremin_1511(:,1),REF_sed_PO4_allremin_1511(:,3)*1e+6,'m',REF_sed_PO4_allremin(:,1),REF_sed_PO4_allremin(:,3)*1e+6,'b',REF_sed_PO4_smallerk(:,1),REF_sed_PO4_smallerk(:,3)*1e+6,'r',REF_sed_PO4_NoOMEN(:,1),REF_sed_PO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_PO4_SPIN(:,1),REF_sed_PO4_SPIN(:,3)*1e+6,'k:'); 
xlabel('yrs ');
...
%plot(REF_sed_ALK_allremin(:,1),REF_sed_ALK_allremin(:,3)*1e+6,'b',REF_sed_ALK_smallerk(:,1),REF_sed_ALK_smallerk(:,3)*1e+6,'r',REF_sed_ALK_NoOMEN(:,1),REF_sed_ALK_NoOMEN(:,3)*1e+6,'g--',REF_sed_ALK_SPIN(:,1),REF_sed_ALK_SPIN(:,3)*1e+6,'k:'); 
plot(REF_sed_ALK_allremin_1511(:,1),REF_sed_ALK_allremin_1511(:,3)*1e+6,'m',REF_sed_ALK_allremin(:,1),REF_sed_ALK_allremin(:,3)*1e+6,'b',REF_sed_ALK_smallerk(:,1),REF_sed_ALK_smallerk(:,3)*1e+6,'r',REF_sed_ALK_NoOMEN(:,1),REF_sed_ALK_NoOMEN(:,3)*1e+6,'g--',REF_sed_ALK_SPIN(:,1),REF_sed_ALK_SPIN(:,3)*1e+6,'k:'); 
xlabel('yrs ');
...
%plot(REF_sed_DIC(:,1),REF_sed_DIC(:,3)*1e+6,'b', REF_sed_DIC_smallerk(:,1),REF_sed_DIC_smallerk(:,3)*1e+6,'r',REF_sed_ALK_NoOMEN(:,1),REF_sed_ALK_NoOMEN(:,3)*1e+6,'g--',REF_sed_DIC_SPIN(:,1),REF_sed_DIC_SPIN(:,3)*1e+6,'k:'); 
...
plot(REF_sed_DIC_allremin_1511(:,1),REF_sed_DIC_allremin_1511(:,3)*1e+6,'m',REF_sed_DIC_allremin(:,1),REF_sed_DIC_allremin(:,3)*1e+6,'b',REF_sed_DIC_smallerk(:,1),REF_sed_DIC_smallerk(:,3)*1e+6,'r',REF_sed_DIC_NoOMEN(:,1),REF_sed_DIC_NoOMEN(:,3)*1e+6,'g--',REF_sed_DIC_SPIN(:,1),REF_sed_DIC_SPIN(:,3)*1e+6,'k:'); 
xlabel('yrs ');
...
print('-depsc', 'cgenie_output/plots1511/0_ALL-time-series_1511');
...
REF_sed_pCO2_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_atm_pCO2.res'),'ascii');
...
REF_sed_pCO2_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_atm_pCO2.res'),'ascii');

REF_sed_pO2_allremin = load(fullfile(exp_1,'/biogem/biogem_series_atm_pO2.res'),'ascii');
REF_sed_pO2_allremin_extra = load(fullfile(exp_1_extra,'/biogem/biogem_series_atm_pO2.res'),'ascii');
...
REF_sed_pO2_allremin_1511 = load(fullfile(exp_5,'/biogem/biogem_series_atm_pO2.res'),'ascii');
...
%plot(REF_sed_pCO2_allremin(:,1),REF_sed_pCO2_allremin(:,3)*1e+6,'b',REF_sed_pCO2_smallerk(:,1),REF_sed_pCO2_smallerk(:,3)*1e+6,'r',REF_sed_pCO2_SPIN(:,1),REF_sed_pCO2_SPIN(:,3)*1e+6,'k:' ); 
...
plot(REF_sed_pCO2_allremin_1511(:,1),REF_sed_pCO2_allremin_1511(:,3)*1e+6,'m',REF_sed_pCO2_allremin(:,1),REF_sed_pCO2_allremin(:,3)*1e+6,'b',REF_sed_pCO2_smallerk(:,1),REF_sed_pCO2_smallerk(:,3)*1e+6,'r',REF_sed_pCO2_NoOMEN(:,1),REF_sed_pCO2_NoOMEN(:,3)*1e+6,'g--',REF_sed_pCO2_SPIN(:,1),REF_sed_pCO2_SPIN(:,3)*1e+6,'k:'); 
xlabel('time (years) ');
...
%plot(REF_sed_pO2(:,1),REF_sed_pO2(:,3),'b',REF_sed_pO2_smallerk(:,1),REF_sed_pO2_smallerk(:,3),'r',REF_sed_pO2_SPIN(:,1),REF_sed_pO2_SPIN(:,3),'k:' );
...
plot(REF_sed_pO2_allremin_1511(:,1),REF_sed_pO2_allremin_1511(:,3),'m',REF_sed_pO2_allremin(:,1),REF_sed_pO2_allremin(:,3),'b',REF_sed_pO2_smallerk(:,1),REF_sed_pO2_smallerk(:,3),'r',REF_sed_pO2_NoOMEN(:,1),REF_sed_pO2_NoOMEN(:,3),'g--',REF_sed_pO2_SPIN(:,1),REF_sed_pO2_SPIN(:,3),'k:'); 
xlabel('time (years) ');
...
print('-depsc', 'cgenie_output/plots1511/0_Atmp-time-series_1511');