...
plot(REF_sed_O2_allremin(:,1),REF_sed_O2_allremin(:,3)*1e+6,'b',REF_sed_O2_NoOMEN(:,1),REF_sed_O2_NoOMEN(:,3)*1e+6,'g--',REF_sed_O2_SPIN(:,1),REF_sed_O2_SPIN(:,3)*1e+6,'k:'); 
...
% plot(REF_sed_SO4_allremin(:,1),REF_sed_SO4_allremin(:,3)*1e+6,'b',REF_sed_SO4_NoOMEN(:,1),REF_sed_SO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_SO4_NoOMEN(:,1),REF_sed_SO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_SO4_SPIN(:,1),REF_sed_SO4_SPIN(:,3)*1e+6,'k:' ); 
% xlabel('yrs ');
% ylabel('SO_4 (\mumol kg^{-1})');
% hleg=legend('OPEN: No CaCO3, OMEN: all remin','OPEN: No CaCO3, No-OMEN', 'SPIN: Closed with CaCO3 - No OMEN'); 
% set(hleg,'FontSize',4);
% set(hleg,'Location','best')
% 
% subplot(3,2,3)
% %plot(REF_sed_H2S(:,1),REF_sed_H2S(:,3)*1e+6,'b', REF_sed_H2S_smallerk(:,1),REF_sed_H2S_smallerk(:,3)*1e+6,'r');
% plot(REF_sed_H2S_allremin(:,1),REF_sed_H2S_allremin(:,3)*1e+6,'b', REF_sed_H2S_NoOMEN(:,1),REF_sed_H2S_NoOMEN(:,3)*1e+6,'g--', REF_sed_H2S_NoOMEN(:,1),REF_sed_H2S_NoOMEN(:,3)*1e+6,'g--',REF_sed_H2S_SPIN(:,1),REF_sed_H2S_SPIN(:,3)*1e+6,'k:');
...
plot(REF_sed_PO4_allremin(:,1),REF_sed_PO4_allremin(:,3)*1e+6,'b', REF_sed_PO4_NoOMEN(:,1),REF_sed_PO4_NoOMEN(:,3)*1e+6,'g--',REF_sed_PO4_SPIN(:,1),REF_sed_PO4_SPIN(:,3)*1e+6,'k:'); 
...
plot(REF_sed_ALK_allremin(:,1),REF_sed_ALK_allremin(:,3)*1e+6,'b', REF_sed_ALK_NoOMEN(:,1),REF_sed_ALK_NoOMEN(:,3)*1e+6,'g--',REF_sed_ALK_SPIN(:,1),REF_sed_ALK_SPIN(:,3)*1e+6,'k:'); 
...
plot(REF_sed_DIC_allremin(:,1),REF_sed_DIC_allremin(:,3)*1e+6,'b', REF_sed_DIC_NoOMEN(:,1),REF_sed_DIC_NoOMEN(:,3)*1e+6,'g--',REF_sed_DIC_SPIN(:,1),REF_sed_DIC_SPIN(:,3)*1e+6,'k:'); 
...
print('-depsc', 'cgenie_output/plots2211_NEW_Dissflux/0_ALL-time-series_2211');
...
plot(REF_sed_pCO2_allremin(:,1),REF_sed_pCO2_allremin(:,3)*1e+6,'b', REF_sed_pCO2_NoOMEN(:,1),REF_sed_pCO2_NoOMEN(:,3)*1e+6,'g--', REF_sed_pCO2_SPIN(:,1),REF_sed_pCO2_SPIN(:,3)*1e+6,'k:' ); 
...
plot(REF_sed_pO2_allremin(:,1),REF_sed_pO2_allremin(:,3),'b',REF_sed_pO2_NoOMEN(:,1),REF_sed_pO2_NoOMEN(:,3),'g--',REF_sed_pO2_SPIN(:,1),REF_sed_pO2_SPIN(:,3),'k:' );
...
print('-depsc', 'cgenie_output/plots2211_NEW_Dissflux/0_Atmp-time-series_2211');